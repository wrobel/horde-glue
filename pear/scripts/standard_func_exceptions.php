<?php
/**
 * standard extension Function Exceptions dictionary
 ...
 * @version  CVS: $Id: standard_func_exceptions.php,v 1.1 2008/12/31 13:10:35 farell Exp $
 * @link     http://pear.php.net/package/PHP_CompatInfo
 * @since    version 1.9.0 (2009-01-19)
 */

if (!isset($function_exceptions['standard'])) {
    $function_exceptions['standard'] = array();
}

$function_exceptions['standard'] = array_merge($function_exceptions['standard'], array(
  'abs' =>
  array (
    'init' => '4.0.0',
    'ext' => 'standard',
